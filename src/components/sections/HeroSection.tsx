...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="min-h-[90vh] flex flex-col px-gutter mx-auto relative pt-20 overflow-hidden"
    >
      ...
      {/* Main content — flex-1 pushes the arrow to the bottom */}
      <div className="flex-1 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 pointer-events-none w-full">
          ...
          {/* Right column spacer for 3D background balance */}
          <div className="relative w-full aspect-square max-w-[500px] lg:max-w-none lg:h-[600px] pointer-events-none hidden lg:block" />
        </div>
      </div>

      {/* Scroll indicator — normal flow, always visible on all screen sizes */}
      <div className="relative z-30 flex justify-center py-6">
        <a
          href="#about"
          className="flex items-center justify-center w-12 h-12 rounded-full border border-primary/20 bg-void-black/40 backdrop-blur-sm opacity-60 hover:opacity-100 transition-opacity animate-bounce"
